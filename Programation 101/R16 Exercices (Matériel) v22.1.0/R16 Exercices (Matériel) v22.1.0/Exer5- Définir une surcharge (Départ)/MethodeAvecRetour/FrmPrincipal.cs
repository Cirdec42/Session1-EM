...
namespace MethodeAvecRetour
{
    ...
    public partial class FrmPrincipal : Form
    {
        ...
        private void MinimumEntre(int pNombre1, int pNombre2, int pNombre3)
        {
        ...
        /// <returns>Le plus petit des quatres nombres</returns>
        private void MinimumEntre(int pNombre1, int pNombre2, int pNombre3, int pNombre4)
        {
